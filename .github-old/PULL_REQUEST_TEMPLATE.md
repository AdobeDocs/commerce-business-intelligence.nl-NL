...
See Contribution guidelines (https://github.com/AdobeDocs/commerce-business-intelligence.nl-NL/blob/main/contributing.md) for more information.
-->
...
If this pull request introduces changes that should be highlighted in the [What's New section](https://experienceleague.adobe.com/nl/docs/commerce-business-intelligence/mbi/guide-overview#whats-new), see _What's New highlights_ in the [Contribution guidelines](https://github.com/AdobeDocs/commerce-business-intelligence.nl-NL/blob/main/contributing.md#whats-new-highlights).
-->