...
| [`purchases`](https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/Purchase) | De `purchases` de tabel geeft uw uitgaven weer en bevat de aankoop-id, het type betaling, het bedrag en eventuele informatie over lijnobjecten. |
