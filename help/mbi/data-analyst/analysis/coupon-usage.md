...
Deze maatstaf toont de netto-inkomsten die u verkrijgt uit orders die een bepaalde coupon bevatten. De netto-inkomsten zijn een berekening van de prijs van de verkochte posten na toepassing van alle kortingen. Dit kan helpen bepalen welke coupons worden gekoppeld aan de hoogste en laagste netto-inkomsten.

### Percentage met korting
...
Deze maatstaf toont de gemiddelde bestelwaarde wanneer een coupon wordt toegepast. U kunt analyseren of opdrachten met coupons consistent een lagere orderwaarde hebben dan orders zonder coupons.

### Gemiddelde orderkorting

Dit toont de gemiddelde dollarwaarde van elke orde waar coupons worden toegepast. Dit geeft het verschil weer tussen de gemiddelde nettoorderwaarde en de gemiddelde brutoorderwaarde.
...
* De coupon van &quot;10% korting&quot; werd tijdens de zomermaanden aangeboden, maar de onderneming verkoopt winterkleding.

* de beperkingen op de coupons. Bijvoorbeeld:
* Het coupon &quot;$10 korting&quot; wordt alleen aangeboden aan nieuwe klanten.
...
Anderzijds heeft de coupon &quot;10% korting&quot; een hoge gemiddelde discontowaarde ($25,01), maar de laagste waarde **verlaagd percentage**. Dit is logisch als je de gemiddelde waarde van je nettobestelling van $ 225,08 opneemt. De coupon met een &quot;10% korting&quot; heeft een kleine procentuele korting op een grote gemiddelde nettoorderwaarde, dus de gemiddelde orderkorting is een groot bedrag.

Kijk naar de **afzonderlijke kopers** en **gemiddelde omzet in levensduur** voor elke coupon. De coupon &quot;10% korting&quot; heeft hetzelfde aantal orders als afzonderlijke kopers. Dit kan het gevolg zijn van het feit dat elke klant beperkt is tot één coupon. Anderzijds hebben de coupons &quot;$20 van $100 of meer&quot; en &quot;$10 korting&quot; minder duidelijke kopers dan het aantal orders, wat betekent dat sommige klanten deze coupons meerdere keren hebben gebruikt.
...
De analyses die in dit onderwerp worden genoemd kunnen u waardevolle inzichten geven in hoe uw klanten uw coupons gebruiken, maar er zijn een groot aantal andere analyses waarmee u wat dieper kunt graven.

**Je zou je klantenwervingen kunnen analyseren op basis van coupons.**

Welke coupons moedigen klanten aan om orders te plaatsen? Zijn deze coupons aantrekkelijk voor eenmalig kopers of stimuleren ze de klantloyaliteit (met andere woorden: klanten die herhaalde aankopen doen)?
