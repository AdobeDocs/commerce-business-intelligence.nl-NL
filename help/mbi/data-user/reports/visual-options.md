...
Als u een rapport wilt opslaan als een trechterdiagram, past u het rapport `Type` aan `Chart` aan en selecteert u de gewenste visualisatie in de rapportbuilder.
...
![ zonder trendline ](../../assets/scatter-plot-2.png)
